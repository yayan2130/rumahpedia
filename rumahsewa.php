...
<html>
  ...
  <div class="judul row">
    <div class="judul-kiri">
      <h1 class="header-judul bold"> Daftar Rumah Sewa </h1>
      <div class="kurangkiri">
      <form method="get" action="rumahsewa.php">
...
include 'koneksi.php';
    if(isset($_GET['keyword'])){
        ...
        $query = "SELECT * FROM tb_rumah where tawaran='Disewa' and kata_kunci like '%".$keyword."%' order by id desc";
    }else{
      $query = "SELECT * FROM tb_rumah where tawaran='Disewa'";
